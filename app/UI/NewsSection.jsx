...
export function NewsSection() {
	return (
		<section className="mx-auto max-w-337.5 px-[6.75vw]">
			<div className="mt-12 flex max-w-83.25 items-center justify-between gap-4 rounded-3xl bg-[#facc15] px-4 py-2 text-[20px] font-bold text-black">
				<h3 className="m-0 text-center">Recent News</h3>
				<div aria-hidden="true">&lt; &gt;</div>
			</div>

			<article className="mx-auto mt-2 w-full max-w-337.5 rounded-3xl border-b-4 border-black px-4 pb-11 pt-6">
