...
function SocialFunctionItem({ number, description }) {
	return (
		<div className="w-full max-w-[976px] text-zinc-800">
			<div className="flex items-start gap-4 rounded-xl border-b-[3px] border-zinc-800 px-3 pb-[18px] pt-2">
				<div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-full border border-zinc-800 bg-yellow-400">
					<span className="text-base font-medium">{number}</span>
				</div>

				<div className="min-w-[200px] flex-1 self-center text-lg">
					{description}
				</div>
			</div>
		</div>
...
export default function SocialFunctions() {
	return (
		<section className="mx-auto flex w-full max-w-[1350px] flex-col items-start">
			...
			<div className="mt-4 flex w-full max-w-[750px] flex-wrap justify-between gap-4">
				<div className="min-w-[280px] flex-[1_1_60%] text-xl">
					<SocialFunctionItem
						number="1"
			...
			<div className="mx-auto mt-7 w-full max-w-[1350px] rounded-lg border-b-[3px] border-black p-3 text-xl text-black">
				<p>
